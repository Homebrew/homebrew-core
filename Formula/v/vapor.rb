class Vapor < Formula
  ...
  url "https://github.com/vapor/toolbox/archive/refs/tags/20.0.1.tar.gz"
  sha256 "3fbd7eb255e2b5233cac7d6a83ce5670c07d46b7124df885d8bbdd5de72933d3"
  license "MIT"
  ...
  test do
    system bin/"vapor", "new", "hello-world", "--no-fluent", "--no-leaf"
