class V8 < Formula
  ...
  url "https://github.com/v8/v8/archive/refs/tags/14.9.207.27.tar.gz"
  sha256 "bad57aaf09d08798a32500f942295f7a0b29b579c553a6ba464f9193684ce6df"
  ...
  def install
    ...
    inreplace buildpath/"build/config/compiler/BUILD.gn", "cflags += [ \"-fno-lifetime-dse\" ]", ""
...
index 410ff60bc..7b8643124 100644
--- a/config/compiler/BUILD.gn
+++ b/config/compiler/BUILD.gn
@@ -1574,23 +1574,10 @@ config("clang_warning_suppression") {
