class Buildifier < Formula
  ...
  def install
    ...
    (dir/"go.sum").write <<~EOS
      ...
      github.com/bazelbuild/buildtools v0.0.0-20210208125002-752270cf2f52 h1:rasH3B1wKowzIidicsn3XcoNxIer8WeE0CSm14R2Un4=
      github.com/bazelbuild/buildtools v0.0.0-20210208125002-752270cf2f52/go.mod h1:5JP0TXzWDHXv8qvxRC4InIazwdyDseBDbzESUMKk1yU=
    ...
    EOS
    cd dir do
      system "go", "build", "-o", bin/"buildifier", "-ldflags", ldflags.join(" ")
    end
  end
