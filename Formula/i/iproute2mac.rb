class Iproute2mac < Formula
  ...
  url "https://github.com/brona/iproute2mac/releases/download/v1.7.2/iproute2mac-1.7.2.tar.gz"
  ...
  conflicts_with "iproute-mac", because: "both install `ip`, `bridge` and `ss` binaries"
