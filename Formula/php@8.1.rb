class PhpAT81 < Formula
  ...
  url "https://downloads.php.net/~patrickallaert/php-8.1.0RC2.tar.xz"
  sha256 "732f006fcec5e7f418ab79110d88becfb918388858fbe667d17b058a54876efc"
  license "PHP-3.01"

  livecheck do
    url "https://downloads.php.net/~patrickallaert"
    regex(/href=.*?php[._-]v?(\d+(?:\.\d+)+RC\d)\.t/i)
  end

  keg_only :versioned_formula

  deprecate! date: "2024-12-01", because: :versioned_formula
