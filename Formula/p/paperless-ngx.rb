class PaperlessNgx < Formula
  ...
  resource "concurrent-log-handler" do
    url "https://files.pythonhosted.org/packages/e0/e4/6a7a56049c06b3f878cc427118b6b8e46a7c2926828da9864198430d4020/concurrent_log_handler-0.9.25.tar.gz"
  ...
  resource "django-auditlog" do
    url "https://files.pythonhosted.org/packages/44/df/6cbc296b2fdd808bd710671409a1a838c9741670933f170930cb7b9c5804/django-auditlog-3.0.0.tar.gz"
  ...
  resource "drf-spectacular-sidecar" do
    url "https://files.pythonhosted.org/packages/80/5c/85671ba50957e0ab45e2828ca713cd7b5d0d237c398936c1b45bd0286b72/drf_spectacular_sidecar-2025.3.1.tar.gz"
  ...
  resource "gotenberg-client" do
    url "https://files.pythonhosted.org/packages/20/7f/2bb2ab55a3f00d859649094327e7e3a71776957f40fdf79a53ad68960afe/gotenberg_client-0.9.0.tar.gz"
    sha256 "bd3c1ed42b74d470a7e192118276f3d91b558b90aa7c0035afbcac04f42179bb"
  end

  resource "granian" do
    url "https://files.pythonhosted.org/packages/30/b8/72d80a6076f2ab3667e727db08be74957827813bd2e133f603b89266af54/granian-2.2.6.tar.gz"
    sha256 "2693105eeadfa76ef37d6b62bad1b270bbce4bcac404ede61011736465ef3025"
  end
  ...
  resource "hiredis" do
    url "https://files.pythonhosted.org/packages/38/e5/789cfa8993ced0061a6ef7ea758302ef5cf3439629bf0d39c85a6ede4641/hiredis-3.1.0.tar.gz"
  ...
  test do
    ...
    begin
      ...
      sleep 5
      assert_match "Listening at: http://127.0.0.1:#{port}", output_log.read
    ensure
