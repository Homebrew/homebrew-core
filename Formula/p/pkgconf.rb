class Pkgconf < Formula
  ...
  url "https://distfiles.ariadne.space/pkgconf/pkgconf-2.9.92.tar.xz"
  mirror "https://fossies.org/linux/misc/pkgconf-2.9.92.tar.xz"
  mirror "http://fresh-center.net/linux/misc/pkgconf-2.9.92.tar.xz"
  sha256 "71848a94990e991668ea16107aaea40cc4e33fd4cb79dbd177ca34f5cce95ab1"
  license "ISC"
