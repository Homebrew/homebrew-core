class AnsibleAT19 < Formula
  ...
  resource "paramiko" do
    url "https://files.pythonhosted.org/packages/source/p/paramiko/paramiko-1.15.2.tar.gz"
  ...
  resource "backports.ssl_match_hostname" do
    url "https://files.pythonhosted.org/packages/source/b/backports.ssl_match_hostname/backports.ssl_match_hostname-3.4.0.2.tar.gz"
    sha256 "07410e7fb09aab7bdaf5e618de66c3dac84e2e3d628352814dc4c37de321d6ae"
  end

  resource "docker-py" do
    url "https://files.pythonhosted.org/packages/source/d/docker-py/docker-py-1.5.0.tar.gz"
    sha256 "6924128fac46afef0de16ebdffc30a8c071246312260f289d895129f4e00f8d0"
  end

  resource "websocket-client" do
    url "https://files.pythonhosted.org/packages/source/w/websocket-client/websocket_client-0.34.0.tar.gz"
  ...
  #
  resource "isodate" do
    url "https://files.pythonhosted.org/packages/source/i/isodate/isodate-0.5.1.tar.gz"
    sha256 "b12aed31c0e834543497e24d609a41531a800d8304c39e6665c45ca023b012fb"
  end

  resource "pywinrm" do
    url "https://files.pythonhosted.org/packages/source/p/pywinrm/pywinrm-0.0.3.tar.gz"
  ...
  #
  resource "Babel" do
    url "https://files.pythonhosted.org/packages/source/B/Babel/Babel-2.1.1.tar.gz"
    sha256 "7fb6d50effe88a087feb2036cb972fd7a893bf338361516f1a55a820bf7b5248"
  end

  resource "debtcollector" do
    url "https://files.pythonhosted.org/packages/source/d/debtcollector/debtcollector-0.10.0.tar.gz"
    sha256 "8cc22cf2223af7789692ef0b1cb5c0c3a00da7d6e34cbfce125a956cb4d2f21e"
  end

  resource "funcsigs" do
    url "https://files.pythonhosted.org/packages/source/f/funcsigs/funcsigs-0.4.tar.gz"
  ...
  resource "keyring" do
    url "https://files.pythonhosted.org/packages/source/k/keyring/keyring-5.6.tar.gz"
  ...
  resource "monotonic" do
    url "https://files.pythonhosted.org/packages/source/m/monotonic/monotonic-0.4.tar.gz"
    sha256 "852f656adbf623ee859def6ca2f5498f4cae3256f8320d5c50570ee8a0592ab6"
  end

  resource "msgpack-python" do
    url "https://files.pythonhosted.org/packages/source/m/msgpack-python/msgpack-python-0.4.6.tar.gz"
  ...
  resource "os_diskconfig_python_novaclient_ext" do
    url "https://files.pythonhosted.org/packages/source/o/os_diskconfig_python_novaclient_ext/os_diskconfig_python_novaclient_ext-0.1.2.tar.gz"
  ...
  resource "oslo.config" do
    url "https://files.pythonhosted.org/packages/source/o/oslo.config/oslo.config-2.6.0.tar.gz"
    sha256 "5d5f1cba6c6175a4222d71ae9aac031054c79529b67cb5e43cb627e8837a9ee5"
  end

  resource "oslo.i18n" do
    url "https://files.pythonhosted.org/packages/source/o/oslo.i18n/oslo.i18n-2.7.0.tar.gz"
    sha256 "9f510fd251510ca670ef876783a1727f67fe7a27595d772057273d33e4664f86"
  end

  resource "oslo.serialization" do
    url "https://files.pythonhosted.org/packages/source/o/oslo.serialization/oslo.serialization-1.11.0.tar.gz"
    sha256 "b9a5b8bd4583957476464016f1c4d3ca01a30a0125acb1cd0ddd830715c88e1f"
  end

  resource "oslo.utils" do
    url "https://files.pythonhosted.org/packages/source/o/oslo.utils/oslo.utils-2.7.0.tar.gz"
  ...
  resource "pyrax" do
    url "https://files.pythonhosted.org/packages/source/p/pyrax/pyrax-1.9.5.tar.gz"
    sha256 "59ac98ae0549beb1eb36cc1f4985d565f126adbfa596d7fa5aaccde5ef194c0e"
  end

  resource "python-keystoneclient" do
    url "https://files.pythonhosted.org/packages/source/p/python-keystoneclient/python-keystoneclient-1.8.1.tar.gz"
  ...
  resource "simplejson" do
    url "https://files.pythonhosted.org/packages/source/s/simplejson/simplejson-3.8.1.tar.gz"
    sha256 "428ac8f3219c78fb04ce05895d5dff9bd813c05a9a7922c53dc879cd32a12493"
  end

  resource "stevedore" do
    url "https://files.pythonhosted.org/packages/source/s/stevedore/stevedore-1.9.0.tar.gz"
    sha256 "cc19908840498ed5f7cb5cf59bbe47b41aa9d65821548e2b3c8a99a571cbec06"
  end

  resource "wrapt" do
    url "https://files.pythonhosted.org/packages/source/w/wrapt/wrapt-1.10.5.tar.gz"
  ...
  #
  resource "pyasn1" do
    url "https://files.pythonhosted.org/packages/source/p/pyasn1/pyasn1-0.1.8.tar.gz"
  ...
  resource "decorator" do
    url "https://files.pythonhosted.org/packages/source/d/decorator/decorator-4.0.4.tar.gz"
  ...
  resource "futures" do
    url "https://files.pythonhosted.org/packages/source/f/futures/futures-3.0.3.tar.gz"
  ...
  resource "keystoneauth1" do
    url "https://files.pythonhosted.org/packages/source/k/keystoneauth1/keystoneauth1-1.2.0.tar.gz"
  ...
  resource "pyparsing" do
    url "https://files.pythonhosted.org/packages/source/p/pyparsing/pyparsing-2.0.5.tar.gz"
    sha256 "58756bf33e989d84ac72142e4ca558cf10c778a3233edb0a86632f271409ba9e"
  end

  resource "python-cinderclient" do
    url "https://files.pythonhosted.org/packages/source/p/python-cinderclient/python-cinderclient-1.1.2.tar.gz"
  ...
  resource "python-heatclient" do
    url "https://files.pythonhosted.org/packages/source/p/python-heatclient/python-heatclient-0.8.0.tar.gz"
    sha256 "5cd1c855ee21f18bfffbc7269e40c417b953d0855aa3cc8b56d778b8612467d5"
  end

  resource "python-ironicclient" do
    url "https://files.pythonhosted.org/packages/source/p/python-ironicclient/python-ironicclient-0.10.0.tar.gz"
    sha256 "53259ad9fc3b2d4a38b61ded24e89ca226e91c700daae1d9639251a20b6c7990"
  end

  resource "python-neutronclient" do
    url "https://files.pythonhosted.org/packages/source/p/python-neutronclient/python-neutronclient-3.1.0.tar.gz"
    sha256 "02c432b35806f4017c9041ac609a367e0423973cdb48706c3c807c8a56e9263d"
  end

  resource "python-openstackclient" do
    url "https://files.pythonhosted.org/packages/source/p/python-openstackclient/python-openstackclient-1.8.0.tar.gz"
    sha256 "d71369f802d8d537efc576acc437465d636e1aadc20f011e6bbdc38597db5258"
  end

  resource "python-swiftclient" do
    url "https://files.pythonhosted.org/packages/source/p/python-swiftclient/python-swiftclient-2.6.0.tar.gz"
    sha256 "f7344b2a66ec0518d97e262a083b7e30e41fc0eb8e50661dd300e29d3ea163c8"
  end

  resource "python-troveclient" do
    url "https://files.pythonhosted.org/packages/source/p/python-troveclient/python-troveclient-1.4.0.tar.gz"
    sha256 "990c8d6b8b506ce35b883290d59932b6d08e8367f990bc3d365d659cfa9c2b51"
  end

  resource "shade" do
    url "https://files.pythonhosted.org/packages/source/s/shade/shade-1.0.0.tar.gz"
