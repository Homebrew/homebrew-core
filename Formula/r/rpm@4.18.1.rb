class RpmAT4181 < Formula
  ...
  def install
    # ENV.store "CFLAGS", "-I/Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include" if OS.mac?
    ENV.store "CC", "#{HOMEBREW_PREFIX}/bin/gcc-12" if OS.mac?
    ENV.append "CFLAGS", "-I#{HOMEBREW_PREFIX}/opt/libarchive/include -I#{HOMEBREW_PREFIX}/include" if OS.mac?
    ENV.append "LDFLAGS", "-lomp -L#{HOMEBREW_PREFIX}/opt/libarchive/lib" if OS.mac?
