class Reuse < Formula
  ...
  url "https://github.com/fsfe/reuse-tool/archive/refs/tags/v5.0.2.tar.gz"
  sha256 "a28c23bce1581a338db056cfc3e196cbe5b1701f5e2944a2c61afa50fb1d4954"
  # License summary from project README (April 2024):
  # - Original source code: GPL-3.0-or-later.
  # - Documentation: CC-BY-SA-4.0.
  # - Some config and data files: CC0-1.0.
  # - Some code from spdx/tools-python: Apache-2.0.
  # Verified: `reuse spdx | awk '/LicenseInfoInFile/{print $2}' | sort --unique`
  license all_of: [
    "GPL-3.0-or-later",
    "CC-BY-SA-4.0",
    "CC0-1.0",
  ...
  livecheck do
    url :stable
    # Other strategies include non-releases.
  ...
  test do
    testfilepath = testpath + "testfile.rb"
    touch testfilepath
    system bin/"reuse", "annotate", '--copyright="Homebrew Maintainers"', "--exclude-year", "--license=BSD-2-Clause", testfilepath
    header = "# SPDX-FileCopyrightText: \"Homebrew Maintainers\"\n#\n# SPDX-License-Identifier: BSD-2-Clause\n"
    assert_equal header, testfilepath.read
    system bin/"reuse", "download", "BSD-2-Clause"
    assert_predicate testpath/"LICENSES/BSD-2-Clause.txt", :exist?
  end
end
