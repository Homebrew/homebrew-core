class Librest < Formula
  ...
  # We use a common regex because librest doesn't use GNOME's "even-numbered minor
  ...
  depends_on "libsoup@2" # libsoup3 issue for gnome-recipes: https://gitlab.gnome.org/GNOME/recipes/-/issues/155
