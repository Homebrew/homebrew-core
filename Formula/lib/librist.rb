class Librist < Formula
  ...
  url "https://code.videolan.org/rist/librist/-/archive/v0.2.8/librist-v0.2.8.tar.gz"
  sha256 "db2dc9dd01f9ba258d728ac6c9d7a62b9fd452053a44007d08a70463870e2dd8"
  ...
  def install
    ENV.append_to_cflags "-U_POSIX_C_SOURCE -D_POSIX_C_SOURCE=200809L"
