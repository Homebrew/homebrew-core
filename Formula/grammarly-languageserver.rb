class GrammarlyLanguageserver < Formula
  ...
  def install
    ...
    system "cp", "-Lr", "#{buildpath}/packages/grammarly-languageserver", "#{libexec}/lib/node_modules"
    (libexec/"bin/grammarly-languageserver").write_env_script "#{libexec}/lib/node_modules/grammarly-languageserver/bin/server.js", :NODE_PATH => "#{libexec}/lib/node_modules"
    system "chmod", "+x", "#{libexec}/bin/grammarly-languageserver"
