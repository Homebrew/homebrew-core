...
class Mercurial < Formula
  ...
  sha256 "9efa9da5f497a8750ac9c48fa431c4ab72209f1360180c5d4920d1311b0420df"
  ...
  def install
    ...
    inreplace "Makefile", "--prefix=\"$(PREFIX)\"", "\\0 #{extra_flags.join(" ")}"
  ...
  def caveats
    ...
    cacerts_configured = Utils.safe_popen_read(bin/"hg", "config", "web.cacerts").strip
