class Morpheus < Formula
  ...
  url "https://gitlab.com/morpheus.lab/morpheus/-/archive/v2.2.5/morpheus-v2.2.5.tar.gz"
  sha256 "a1280e2e0d50915c55920b33d19c7d720f5aafb72774790417b716fc40bad745"
  ...
  def install
    args = std_cmake_args
    args << "-DMORPHEUS_GRAPHVIZ=WebRenderer"
