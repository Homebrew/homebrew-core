class PerconaServerMongodb < Formula
  ...
  url "https://www.percona.com/downloads/percona-server-mongodb-3.6/percona-server-mongodb-3.6.13-3.3/source/tarball/percona-server-mongodb-3.6.13-3.3.tar.gz"
  version "3.6.13-3.3"
