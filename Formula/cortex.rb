class Cortex < Formula
  ...
  url "https://github.com/cortexproject/cortex/archive/v1.5.0-test.0.tar.gz"
  version "1.5.0-test.0"
  sha256 "3f5ee507e1f37d5c7813922ef202c0523175cde8b7f2535703ea2fbb992d2f35"
  license "Apache-2.0"
