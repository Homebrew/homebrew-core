class Pdm < Formula
  ...
  url "https://files.pythonhosted.org/packages/99/1e/60d70498743828cdd48d7eb6c5428695c7d535c62bf13a809bd8b2e48d51/pdm-0.10.1.tar.gz"
  sha256 "600bd03c92ede7973ebf62c8350aef09c5c3f3717fe1a67eb363aabe9f37a1fe"
  license "MIT"
  ...
  resource "python-cfonts" do
    ...
    # https://github.com/frostming/python-cfonts/pull/37
    patch :DATA
  end
