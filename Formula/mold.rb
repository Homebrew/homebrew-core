class Mold < Formula
  ...
  url "https://github.com/rui314/mold/archive/v1.7.0.tar.gz"
  sha256 "ccd685afcdb7047f8a8ce8b5ce3b3cd22205a0ebc548ff1f1da7b35415fafbe4"
  ...
  def install
    ...
    # Do not embed libdir into the binary.
