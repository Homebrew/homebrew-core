class VulkanValidationlayers < Formula
  ...
  stable do
    url "https://github.com/KhronosGroup/Vulkan-ValidationLayers/archive/refs/tags/v1.3.257.tar.gz"
    sha256 "8ca1ee4b5c23befef4a5cd3e0f95171cf4fdeb2551dbf5bc198593301b19fa0f"
