class ApachePulsar < Formula
  ...
  url "https://www.apache.org/dyn/mirrors/mirrors.cgi?action=download&filename=pulsar/pulsar-2.11.0/apache-pulsar-2.11.0-src.tar.gz"
  mirror "https://archive.apache.org/dist/pulsar/pulsar-2.11.0/apache-pulsar-2.11.0-src.tar.gz"
  sha256 "a1d45168808ea0b09b4bfe442937b8804bb91181cb502f2ae2c1d13e81fa81fc"
  license "Apache-2.0"
