class KnotResolver6 < Formula
  ...
  url "https://secure.nic.cz/files/knot-resolver/knot-resolver-6.0.17.tar.xz"
  ...
  test do
    ...
    system bin/"kresctl", "schema"
    system bin/"kresctl", "validate", etc/"knot-resolver/config.yaml"
