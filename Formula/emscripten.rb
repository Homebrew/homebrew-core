...
class Emscripten < Formula
  ...
  url "https://github.com/emscripten-core/emscripten/archive/2.0.23.tar.gz"
  sha256 "f4719c1dd31dfb872c9b5a66191114a2a49ee0d290dafda2e05a5f628ed0a3e3"
  license all_of: [
    "Apache-2.0", # binaryen
  ...
  resource "binaryen" do
    url "https://github.com/WebAssembly/binaryen.git",
        revision: "7f31823120ba25075d783df863f6be536543f805"
  end
  ...
  resource "llvm" do
    url "https://github.com/llvm/llvm-project.git",
        revision: "5852582532b3eb3ea8da51a1e272d8d017bd36c9"
  end
