class GitTown < Formula
  ...
  def install
    ...
    system "go", "build", "-o", bin/"git-town", "-ldflags", "-X", "github.com/git-town/git-town/src/cmd.version=v7.4.0", "-X", "github.com/git-town/git-town/src/cmd.buildDate=2020/07/05"
  end
