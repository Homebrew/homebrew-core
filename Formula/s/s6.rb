class S6 < Formula
  ...
  url "https://skarnet.org/software/s6/s6-2.12.0.2.tar.gz"
  ...
  resource "skalibs" do
    url "https://skarnet.org/software/skalibs/skalibs-2.14.0.1.tar.gz"
    sha256 "b43ebdb36f8a8df40f1a08c13b08393bce49faf334e62a0db919b3ae4afd1488"
  end
