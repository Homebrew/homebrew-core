class Shimmy < Formula
  ...
  url "https://github.com/Michael-A-Kuykendall/shimmy/archive/refs/tags/v2.0.1.tar.gz"
  sha256 "d9114c5d1e41d84916961669cba50a326dcef2825f8899a84090e08ebae07195"
  license "Apache-2.0"
  ...
  test do
    ...
    assert_match "serve", shell_output("#{bin}/shimmy --help")
  end
end
