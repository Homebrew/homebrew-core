class Step < Formula
  ...
  url "https://github.com/smallstep/cli/releases/download/v0.17.3/step_0.17.3.tar.gz"
  sha256 "d890e7cb8df5310dbdff625ef6b8037307e8d8ca4d61ddf9a9dfa1baecc862ed"
  license "Apache-2.0"
  ...
  bottle do
    ...
    sha256 cellar: :any_skip_relocation, x86_64_linux:  "ba514f3a0faace0d7c8e10e739afacfe4f213d2629da1a4910bc371507e79790"
  end
