class Qsv < Formula
  ...
  url "https://github.com/jqnatividad/qsv/archive/0.71.0.tar.gz"
  sha256 "49bc519a09f623a0d31c8b4135bd42b2feee028f68d5d3b75ec3e49726883797"
  ...
  def install
    system "cargo", "install", *std_cargo_args, "--features", "apply,fetch,full"
  end
