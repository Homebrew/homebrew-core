class Mint < Formula
  ...
  url "https://github.com/yonaskolb/Mint/archive/0.17.0.tar.gz"
  sha256 "3200bddc889d9f092bdac58cff776bb06d79c64cf443c1a26a67633be2e7988a"
  license "MIT"
  ...
  def install
    ...
    inreplace "Makefile", / --arch (arm|x86_)64/, ""
