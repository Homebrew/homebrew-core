class GhcAT94 < Formula
  ...
  resource "binary" do
    on_macos do
      on_arm do
        url "https://downloads.haskell.org/~ghc/9.2.7/ghc-9.2.7-aarch64-apple-darwin.tar.xz"
        sha256 "a4b63dad502e45da4c65d5255844868eed6bc9157b63fe3fd920f4efb82bb11e"
      end
      on_intel do
        url "https://downloads.haskell.org/~ghc/9.2.7/ghc-9.2.7-x86_64-apple-darwin.tar.xz"
        sha256 "9ab3bc98e32978d555b9ee8cb5996ead330fdcb530575788eb1c12c67441f975"
      end
    end
    on_linux do
      on_arm do
        url "https://downloads.haskell.org/~ghc/9.2.7/ghc-9.2.7-aarch64-deb10-linux.tar.xz"
        sha256 "b4829dd2f4bdaa4b21b22b50edec17616848ab22ab64188047a3eb12bb4da85a"
      end
      on_intel do
        url "https://downloads.haskell.org/~ghc/9.2.7/ghc-9.2.7-x86_64-ubuntu20.04-linux.tar.xz"
        sha256 "b74d8d1afd181dd48ba81a2e8991c01281975b7a25791a0504835d049ae416c3"
      end
    end
  end
