class Manticoresearch < Formula
  ...
  url "https://github.com/manticoresoftware/manticoresearch/archive/refs/tags/13.11.0.tar.gz"
  sha256 "0408c948bacbd24d0d6e7ca72a7f893062827357267f652372cb2006df96b645"
  license all_of: [
    "GPL-3.0-or-later",
    "GPL-2.0-only", # wsrep
