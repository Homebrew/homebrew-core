class Mycli < Formula
  ...
  url "https://files.pythonhosted.org/packages/d4/ca/a1e2a6af893467e1a0c1297f648e4214121d9fe15dfdfa1bff312406d5c7/mycli-2.10.0.tar.gz"
  sha256 "d095018c1e50dcfa8d769e50b68f1b5a2ed7b223bb8cf1ad57ceaf1b1d1e0e58"
  ...
  def install
    ...
    with_env(MATURIN_PEP517_ARGS: "--no-default-features --features full") do
