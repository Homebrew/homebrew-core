class Wasmer < Formula
  ...
  url "https://github.com/wasmerio/wasmer/archive/refs/tags/v6.0.1.tar.gz"
  ...
  def install
    # Link explicitly to libunwind on macOS Ventura ARM to fix Rust linking errors.
    # ld: Undefined symbols:
    # ___unw_add_find_dynamic_unwind_sections, referenced from:
    # ___unw_remove_find_dynamic_unwind_sections, referenced from:
    if OS.mac? && Hardware::CPU.arm? && MacOS.version == :ventura
      ENV["RUSTFLAGS"] = "-C link-arg=-lunwind"
