class Unsloth < Formula
  ...
  depends_on "pygments" => :no_linkage
  depends_on "python@3.13"

  pypi_packages exclude_packages: %w[pydantic pygments]
  ...
  def caveats
    <<~EOS
      Complete the Unsloth Studio setup by running:
        unsloth studio setup
    EOS
  end

  service do
    run [opt_bin/"unsloth", "studio", "-H", "127.0.0.1", "-p", "8888"]
    keep_alive true
    working_dir var
  end
