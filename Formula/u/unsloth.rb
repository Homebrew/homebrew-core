class Unsloth < Formula
  ...
  url "https://files.pythonhosted.org/packages/4a/ff/773a688c855c8c8fc5df6281f15d87aa2092d507e4c7d3e82bae1a77f4a8/unsloth-2026.3.5.tar.gz"
  ...
  service do
    run [opt_bin/"unsloth", "studio", "--host", "127.0.0.1", "--port", "8000", "--silent"]
    keep_alive true
    working_dir var
  end
