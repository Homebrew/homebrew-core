class Trino < Formula
  ...
  url "https://search.maven.org/remotecontent?filepath=io/trino/trino-server/387/trino-server-387.tar.gz"
  ...
  resource "trino-src" do
    url "https://github.com/trinodb/trino/archive/387.tar.gz", using: :nounzip
    sha256 "c16edcb301de1e98f4918787f8c743e08401883c83cabeb0a6e2ee1f9b116814"
  end

  resource "trino-cli" do
    url "https://search.maven.org/remotecontent?filepath=io/trino/trino-cli/387/trino-cli-387-executable.jar"
