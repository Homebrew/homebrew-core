class Dotsnapshot < Formula
  ...
  test do
    ...
    assert_match "1.0.0", shell_output("#{bin}/dotsnapshot --version", 0)
    
    # Test help command
    assert_match "Usage:", shell_output("#{bin}/dotsnapshot --help", 0)
    
    # Test list command
    assert_match "Available snapshot generators:", shell_output("#{bin}/dotsnapshot --list", 0)
  end
