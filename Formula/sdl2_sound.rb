class Sdl2Sound < Formula
  ...
  def install
    args = std_cmake_args
    args += [
      "-D", "SDLSOUND_DECODER_WAV=TRUE",
      "-D", "SDLSOUND_DECODER_AIFF=TRUE",
      "-D", "SDLSOUND_DECODER_AU=TRUE",
      "-D", "SDLSOUND_DECODER_VOC=TRUE",
      "-D", "SDLSOUND_DECODER_FLAC=TRUE",
      "-D", "SDLSOUND_DECODER_VORBIS=TRUE",
      "-D", "SDLSOUND_DECODER_RAW=TRUE",
      "-D", "SDLSOUND_DECODER_SHN=TRUE",
      "-D", "SDLSOUND_DECODER_MODPLUG=TRUE",
      "-D", "SDLSOUND_DECODER_MP3=TRUE",
      "-D", "SDLSOUND_DECODER_MIDI=TRUE"
    ]
