class Snapcraft < Formula
  ...
  url "https://github.com/snapcore/snapcraft.git",
      tag:      "7.0.5",
      revision: "0e9e8cb99eaa7f8da02b0ba3b6a2e467d3c4f643"
  ...
  resource "distro" do
    url "https://files.pythonhosted.org/packages/a6/a4/75064c334d8ae433445a20816b788700db1651f21bdb0af33db2aab142fe/distro-1.7.0.5.tar.gz"
  ...
  resource "zipp" do
    url "https://files.pythonhosted.org/packages/3a/9f/1d4b62cbe8d222539a84089eeab603d8e45ee1f897803a0ae0860400d6e7/zipp-3.7.0.5.tar.gz"
