class Flint < Formula
  ...
  url "https://github.com/flintlib/flint/releases/download/v3.1.1/flint-3.1.2.tar.gz"
  ...
  def install
    ...
    ENV.cxx11
    # Allow -march options to be passed through, as FLINT builds
    ...
    args << "--enable-arch-#{Hardware.oldest_cpu}" if build.bottle?
