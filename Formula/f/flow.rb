class Flow < Formula
  ...
  url "https://github.com/facebook/flow/archive/refs/tags/v0.227.0.tar.gz"
  sha256 "543391e26c1a0d27f119b087ed8075e6da0b54c49bda58b7fc5c07dcd61134ad"
  license "MIT"
  ...
  test do
    ...
    assert_match expected, shell_output("#{bin}/flow check #{testpath}")
  end
end
