class GnomeBuilder < Formula
  ...
  resource "libdex" do
    url "https://download.gnome.org/sources/libdex/0.7/libdex-0.7.0.tar.xz"
    sha256 "ee789f308e8edcd7dd24553bbb543f4b8e37aee64d0589936fa22b9d1bf69f15"

    # macOS ucontext fix, remove in next version of libdex
    patch do
      url "https://gitlab.gnome.org/GNOME/libdex/-/commit/fb8727c2dee6c9636517d5e7673976621894ae5b.diff"
      sha256 "cd8887115774aed0780b5b9896b2a93493a53b6e914937ec92ead90cd5de3b04"
    end
  end
