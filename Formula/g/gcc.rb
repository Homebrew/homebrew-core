class Gcc < Formula
  ...
  stable do
    ...
    patch do
      on_macos do
        url "https://raw.githubusercontent.com/Homebrew/homebrew-core/264693a2b7f/Patches/gcc/gcc-16.1.0.diff"
        sha256 "d22af37a0c7abd7b2a662752269b2541a29d8298f42b6bda4ad2525957f64b78"
      end
    end
  end
