class Gpac < Formula
  ...
  resource "deps_unix" do
    # We can remove this once libcaption is available in Homebrew.
    # Until then, update the revision to the latest whenever stable GPAC is updated.
    url "https://github.com/gpac/deps_unix.git",
        revision: "d2226b9ddf1715091b15b67dc8a799df65e8d576"
  end
