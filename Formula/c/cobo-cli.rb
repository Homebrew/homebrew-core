class CoboCli < Formula
  ...
  homepage "https://github.com/CoboGlobal/cobo-cli/blob/master/README.md"
  url "https://github.com/CoboGlobal/cobo-cli/archive/refs/tags/v0.0.4.tar.gz"
  ...
  test do
    assert_match "Usage: cobo [OPTIONS] COMMAND [ARGS]...", shell_output("#{bin}/cobo -h")
  end
end
