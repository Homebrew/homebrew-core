class AnsibleAT20 < Formula
  ...
  bottle do
    cellar :any
    sha256 "62a5921f7502f0ae12e51e97474da323688672aecf7f1c5aaceef9c6937d4353" => :high_sierra
    sha256 "c0938129d693dc50ec3489f63e04735c00c8aadfdcdb9ae36cda4555ed2383bc" => :sierra
    sha256 "1a6d2b71439cb469e92c203fde617c377a01c19e40c7e586d1981f703a829cbc" => :el_capitan
    sha256 "31b81c7b6d6d996cee0e743654f5086fa5d38147d8f17d3ca77d5e39fa70b99c" => :yosemite
  end
  ...
  resource "enum34" do
    url "https://files.pythonhosted.org/packages/source/e/enum34/enum34-1.1.3.tar.gz"
    sha256 "865506c22462236b3a2e87a7d9587633e18470e7a93a79b594791de2d31e9bc8"
  end

  resource "idna" do
    url "https://files.pythonhosted.org/packages/source/i/idna/idna-2.1.tar.gz"
    sha256 "ed36f281aebf3cd0797f163bb165d84c31507cedd15928b095b1675e2d04c676"
  end

  resource "ipaddress" do
    url "https://files.pythonhosted.org/packages/source/i/ipaddress/ipaddress-1.0.16.tar.gz"
