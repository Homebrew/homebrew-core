class Mactelnet < Formula
  ...
  test do
    assert_equal "MAC-Ping 0.4.4", shell_output("#{bin}/macping -v")
    assert_equal "MAC-Telnet 0.4.4", shell_output("#{bin}/mactelnet -v")
    assert_equal "MAC-Telnet Daemon 0.4.4", shell_output("#{bin}/mactelnetd -v")
  end
end
