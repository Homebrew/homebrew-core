class Hyperkit < Formula
  ...
  def install
    ...
    # This list is from their README.
    # Additional version constraints have been added to ensure reproducible builds.
    system "opam", "exec", "--",
           "opam", "install", "uri.4.1.0", "qcow.0.11.0", "conduit.2.1.0", "lwt.5.4.0",
