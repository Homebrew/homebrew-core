class Headroom < Formula
  ...
  desc "Tool to compress everything your AI agent reads"
  homepage "https://headroomlabs-ai.github.io/headroom/"
  url "https://files.pythonhosted.org/packages/30/af/4ad9124319a0d3d8fba6c6d9bcc7cf45b8ce810e6a5c54f457ed79aa5b02/headroom_ai-0.27.0.tar.gz"
  ...
  resource "ast-grep-cli" do
    url "https://files.pythonhosted.org/packages/f7/23/4437c1e2f91bba450a62c35334c67fb3beddc6900806dff837ef1a5599a1/ast_grep_cli-0.44.0.tar.gz"
  ...
  test do
    db = testpath/"memory.db"
    assert_match "Total Memories: 0", shell_output("#{bin}/headroom memory stats --db-path #{db}")
    assert_match "No memories found", shell_output("#{bin}/headroom memory list --db-path #{db}")
  end
end
