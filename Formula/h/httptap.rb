class Httptap < Formula
  ...
  url "https://files.pythonhosted.org/packages/28/0f/1d9f2b3b2078f909b4971646284435ed6fcabb8a668135af662133cbddb3/httptap-0.1.0-py3-none-any.whl"
  ...
  test do
    output = shell_output("#{bin}/httptap --version")
