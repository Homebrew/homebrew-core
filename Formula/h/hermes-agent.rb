class HermesAgent < Formula
  ...
  url "https://github.com/NousResearch/hermes-agent/archive/refs/tags/v2026.3.12.tar.gz"
  version "0.2.0"
  sha256 "5f46be65992b38fb0621be65c897d51b51ea4138883c9219491a8db7f328e729"
  license "MIT"

  depends_on "rust" => :build # for cryptography, tiktoken, tokenizers, etc.
  ...
  resource "fal-client" do
    url "https://files.pythonhosted.org/packages/0d/2c/3097270895a959aa4304b8e38c598182973ab106166e4ae3810533270bd3/fal_client-0.13.1.tar.gz"
    sha256 "9e1c07d0a61b452a8ffb48c199de5f2543d7546f1230f6312370443127c5e937"
  end
  ...
  resource "firecrawl-py" do
    url "https://files.pythonhosted.org/packages/12/e0/32ee1a80d48c46de4beaa88d799a624c3dfc691f6cb0a7ecd2037885d328/firecrawl_py-4.18.1.tar.gz"
    sha256 "4ffa2034b304ffc50d8e2af5993b7ae40fd39f0f94cedc22b6e06c19470631be"
  end
  ...
  test do
    assert_match "Hermes Agent v#{version}", shell_output("#{bin}/hermes version 2>&1")

    output = shell_output("#{bin}/hermes-agent 2>&1", 1)
    assert_match "OPENAI_API_KEY", output

    assert_match version.to_s, shell_output("python3 -c 'from hermes_cli import __version__; print(__version__)'")
  end
end
