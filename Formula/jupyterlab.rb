class Jupyterlab < Formula
  ...
  resource "nbclient" do
    ...
    sha256 "34f52cc9cb831a5d8ccd7031537e354c75dc61a24487f998712d1289de320a25"
  end
  ...
  def install
    ...
    linked = %w[jupyter-core jupyter-client nbformat jupyter-console nbconvert notebook]
