class NativeSdk < Formula
  ...
  resource "typescript6" do
    url "https://registry.npmjs.org/@typescript/typescript6/-/typescript6-6.0.2.tgz"
    sha256 "bbc2f1a5b64771b59ab89c7a8c74d724a5bbe59b06af453e2a3aa9486e188ba7"
  end
  ...
  def install
    ...
    resource("typescript-old").stage do
      (sdk_root/"node_modules/@typescript/old").install Dir["*"]
    end

    resource("typescript6").stage do
      (sdk_root/"node_modules/@typescript/typescript6").install Dir["*"]
    end
