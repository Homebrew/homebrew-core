class Prestodb < Formula
  ...
  url "https://search.maven.org/remotecontent?filepath=com/facebook/presto/presto-server/0.243.3/presto-server-0.243.3.tar.gz"
  sha256 "d83d97da384214aacc05b5c2a525f408fad59fdcd9d7d80457c15008e9a14f22"
  license "Apache-2.0"
  ...
  resource "presto-cli" do
    url "https://search.maven.org/remotecontent?filepath=com/facebook/presto/presto-cli/0.243.2/presto-cli-0.243.2-executable.jar"
    sha256 "0e1de529977b6e9ee29d9622dfb8685c62086d1cd8d276ca7bcba0b18bcd85e5"
  end
