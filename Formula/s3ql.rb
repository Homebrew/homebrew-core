class S3ql < Formula
  ...
  url "https://github.com/s3ql/s3ql/releases/download/release-3.4.0/s3ql-3.4.0.tar.bz2"
  sha256 "20d2d0221cb9f67ef14f94cc1dfc8ced979a6ed039cf6cc185b56011957f40b2"

  bottle do
    cellar :any
    sha256 "150b046b61b159e53e9ea75a4caf8aa57d5fd1126ae979623b2d3bba2a4f65c6" => :catalina
    sha256 "51ebd5ffe836cc037af238835ea5cc645efc9b0f66573bae6a03bfa28c51b072" => :mojave
    sha256 "d319dda1e0f2a731c4eda35767d72648f3e49ac841eb79d864a9d6361def747c" => :high_sierra
  end
  ...
  # pyfuse3 >= 1.0, < 2.0
  resource "pyfuse3" do
    url "https://files.pythonhosted.org/packages/70/2c/e03061b4a1756e924461437093945e5fe7d3e355cbad5200063c3166d09a/pyfuse3-1.3.1.tar.gz"
  ...
  resource "trio" do
    url "https://files.pythonhosted.org/packages/59/89/6d60b5aef822cf4cdf36a508ee30f13d5addf746472030a95773b5978e4f/trio-0.11.0.tar.gz"
