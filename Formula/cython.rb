class Cython < Formula
  ...
  test do
    ...
    EOS
    system Formula["python@3.10"].opt_bin/"python3", "setup.py", "build_ext", "--inplace"
    assert_match phrase, shell_output("#{Formula["python@3.10"].opt_bin}/python3 -c 'import package_manager'")
  end
end
