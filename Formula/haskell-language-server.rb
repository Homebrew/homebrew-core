class HaskellLanguageServer < Formula
  ...
  # we need :github_latest here because otherwise livecheck picks up spurious non-release tags
  livecheck do
    url :stable
  ...
  def caveats
    ...
    <<~EOS
      #{name} is built for #{versioned_ghc}. You will need to provide
      your own #{versioned_ghc} or install one with
        brew install ghc
    EOS
  end
