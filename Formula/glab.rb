class Glab < Formula
  ...
  def install
    ...
    output = Utils.safe_popen_read({ "SHELL" => "bash" }, bin/"glab", "completion", "-s", "bash")
    (bash_completion/"glab").write output
    output = Utils.safe_popen_read({ "SHELL" => "zsh" }, bin/"glab", "completion", "-s", "zsh")
    (zsh_completion/"_glab").write output
    output = Utils.safe_popen_read({ "SHELL" => "fish" }, bin/"glab", "completion", "-s", "fish")
