class Aztfy < Formula
  ...
  url "https://github.com/Azure/aztfy.git",
      tag:      "v0.8.0",
      revision: "65fe5130b3b8b1ddafbbe4d67d07a3057d00ae40"
  license "MPL-2.0"
  ...
  test do
    ...
    assert_match("ERROR: Please run 'az login' to setup account", no_resource_group_specified_output)
  end
end
