...
class Cntb < Formula
  ...
  test do
    ...
    out = shell_output("#{bin}/cntb get instances --oauth2-user=invalid --oauth2-password=invalid --oauth2-clientid=invalid --oauth2-client-secret=invalid --oauth2-tokenurl=https://example.com 2>&1", 1)
