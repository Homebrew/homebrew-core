class Mockserver < Formula
  ...
  url "https://oss.sonatype.org/content/repositories/releases/org/mock-server/mockserver-netty/5.13.0/mockserver-netty-5.13.0-brew-tar.tar"
  sha256 "b6106b856608aa8f2b6829b330e16d4ae5f7954881b7732496de204d68143d84"
  license "Apache-2.0"
