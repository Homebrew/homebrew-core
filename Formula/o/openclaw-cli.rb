class OpenclawCli < Formula
  ...
  url "https://registry.npmjs.org/openclaw/-/openclaw-2026.5.20.tgz"
  sha256 "28ceb8330cb00354572c23fddacb1544dc661a330d4562f280a3ff72b0108f63"
  license "MIT"
  ...
  def install
    ...
    pi_node_modules.glob("@mariozechner/*").each do |dir|
      ...
      rm_r(dir) unless dir.basename.to_s.include?("gnu") if OS.linux?
    end
