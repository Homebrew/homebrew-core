class Typical < Formula
  ...
  test do
    ...
    assert_match "", shell_output("#{bin}/typical generate types.t --rust types.rs --typescript types.ts")

    generated_rust_code = File.read(testpath/"types.rs")
    generated_typescript_code = File.read(testpath/"types.ts")
