class Lynx < Formula
  ...
  url "https://mirrorservice.org/sites/lynx.invisible-island.net/lynx/tarballs/lynx2.8.8rel.2.tar.bz2"
  mirror "http://invisible-mirror.net/archives/lynx/tarballs/lynx2.8.8rel.2.tar.bz2"
  version "2.8.8rel.2"
