class Aspell < Formula
  ...
  resource "en" do
    url "https://ftpmirror.gnu.org/gnu/aspell/dict/en/aspell6-en-2026.02.25-0.tar.bz2"
    mirror "https://ftp.gnu.org/gnu/aspell/dict/en/aspell6-en-2026.02.25-0.tar.bz2"
  ...
  resource "is" do
    url "https://ftpmirror.gnu.org/gnu/aspell/dict/is/aspell-is-0.51.1-0.tar.bz2"
  ...
  resource "nb" do
    url "https://ftpmirror.gnu.org/gnu/aspell/dict/nb/aspell-nb-0.50.1-0.tar.bz2"
  ...
  test do
    assert_equal "worrd", pipe_output("#{bin}/aspell list -d en_US", "misspell worrd", 0).strip
  end
end
