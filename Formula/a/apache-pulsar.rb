class ApachePulsar < Formula
  ...
  url "https://www.apache.org/dyn/mirrors/mirrors.cgi?action=download&filename=pulsar/pulsar-3.3.1/apache-pulsar-3.3.1-src.tar.gz"
  mirror "https://archive.apache.org/dist/pulsar/pulsar-3.3.1/apache-pulsar-3.3.1-src.tar.gz"
  sha256 "9ffaa4087e6db1f446e5f3e3b366696a8bd7ea58a8a65174345c06e528a61a2b"
  license "Apache-2.0"
