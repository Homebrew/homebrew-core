class Arjun < Formula
  ...
  url "https://files.pythonhosted.org/packages/ef/45/2bb0b350b67624dfb50aa81290add4855b644c901e882a1ba238a46bb2e2/arjun-2.2.3.tar.gz"
  sha256 "80e35b834ac8f491bead760f31df4a492a046b083e7076b11eb29680174a95dc"
  ...
  test do
    output = shell_output("#{bin}/arjun -u https://example.com/ -m GET")
