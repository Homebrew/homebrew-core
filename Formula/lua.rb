...
+	ln -s -f liblua.5.4.0.dylib $(INSTALL_LIB)/liblua.5.4.dylib
+	ln -s -f liblua.5.4.dylib $(INSTALL_LIB)/liblua.dylib

 uninstall:
	cd src && cd $(INSTALL_BIN) && $(RM) $(TO_BIN)
diff --git a/src/Makefile b/src/Makefile
index 514593d..1dd7f6b 100644
--- a/src/Makefile
+++ b/src/Makefile
...
+		-compatibility_version 5.4 -current_version 5.4.0 \
+		-o liblua.5.4.0.dylib $^

 $(LUA_T): $(LUA_O) $(LUA_A)
-	$(CC) -o $@ $(LDFLAGS) $(LUA_O) $(LUA_A) $(LIBS)
+	$(CC) -fno-common $(MYLDFLAGS) -o $@ $(LUA_O) $(LUA_A) -L. -llua.5.4.0 $(LIBS)
